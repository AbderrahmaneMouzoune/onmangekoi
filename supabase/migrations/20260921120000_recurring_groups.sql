...
-- les groupes dont on est membre et les invitations reçues en font désormais
-- partie. Le corps est repris tel quel de `participant_restaurants` — restos
-- contribués et restos apportés compris — avec les deux blocs en plus : une
-- réécriture qui oublie une clé la supprime de l'export de tout le monde.
