...
1. Tu choisis des restaurants — dans une de tes **listes** de favoris, dans la base, chez **Google** (ceux autour de toi, d'abord), ou en ajoutant le tien à la volée — et tu mélanges
...
| Autour de moi      | Nearby Search (New), `rankPreference: DISTANCE`, rayon de 2 km, vingt résultats au plus ; cache par position arrondie à ~100 m |
