...
/**
 * Reflète les filtres dans la barre d'adresse — `?budget=2&tags=vegan` — pour
 * qu'un tri se partage tel quel.
 *
 ...
 * risquer la sélection en cours. Elle n'a pas non plus à peupler l'historique :
