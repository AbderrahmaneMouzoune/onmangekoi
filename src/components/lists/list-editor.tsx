...
export function ListEditor({ list, initialPage, shareUrl }: ListEditorProps) {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] lg:items-start lg:gap-10">
        ...
        >
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <button
              ...
              disabled={isPending}
              className={cn(
                'inline-flex h-11 items-center justify-center gap-2 rounded-md border px-4 text-sm font-semibold transition-colors outline-none focus-visible:ring-3 focus-visible:ring-ring/40 sm:flex-1',
                isCollaborative
