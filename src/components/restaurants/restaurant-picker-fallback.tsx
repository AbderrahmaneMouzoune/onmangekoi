...
/**
 * Silhouette du sélecteur de restaurants : champ de recherche, rangée
 * bouton d'ajout et liste de cartes, aux dimensions exactes du vrai sélecteur.
 * Rendue sur le serveur, elle n'ajoute rien au bundle envoyé au navigateur.
 */
